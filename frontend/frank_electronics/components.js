...
function injectNav(activePage) {
  ...
  const authSection = isLoggedIn
    ...
    : `<a href="${base}login" class="nav-signin-btn" style="background:var(--orange);color:#fff;padding:6px 10px;font-size:11px;font-weight:700;border-radius:6px;text-decoration:none;white-space:nowrap">Sign in</a>`;
